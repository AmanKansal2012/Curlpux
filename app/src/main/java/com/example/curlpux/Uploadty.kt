...
import kotlinx.android.synthetic.main.activity_uploadty.*
import java.util.*

class Uploadty : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_uploadty)
        ...
        storageReference.putFile(selected!!).addOnSuccessListener { taskSnapshot ->
           val downloadURL = taskSnapshot.metadata.toString()
            ...
            taskSnapshot.metadata!!.reference!!.downloadUrl.addOnSuccessListener { uri ->
                myRef!!.child("Posts").child(uuidString).child("downloadUrl").setValue(uri.toString())
            }
